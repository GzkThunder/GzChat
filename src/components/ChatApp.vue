            ...
            <ul class="ui-list app-setting" @mousedown.stop>
              ...
              <li>
                <a class="ui-link" :href="about.github" target="_blank">
                  <img src="https://img.shields.io/github/stars/node-websocket-hatroom?label=Star&style=flat&logo=github" alt="">
                </a>
                <a class="ui-link" :href="about.github" target="_blank">
                  <img src="https://img.shields.io/github/forks/cleverin/noe-websocket-Chatroom?label=Fork&style=flat&logo=github" alt="">
                </a>
              </li>
            </ul>
          </div>
      ...
      <div class="app-iChat-container">
        ...
        <div class="app-iChat-panel" v-show="curMenu==='about'">
          ...
          <ul class="ui-list app-setting">
            ...
            <li>
              <a class="ui-link" :href="about.github" target="_blank">
                <img src="https://img.shields.io/github/stars/clevrqin/node-webocket-Chatroom?label=Star&style=flat&logo=github" alt="">
              </a>
              <a class="ui-link" :href="about.github" target="_blank">
                <img src="https://img.shields.io/github/forks/cleerqin/node-websoket-Chatroom?label=Fork&style=flat&logo=github" alt="">
              </a>
            </li>
          </ul>
        </div>
    ...
    data(){
      ...
      return {
        ...
        about:{
          ...
          license:"我™还没开源",
          author:"GzkThunder",
          email:"3369205186@qq.com",
          github:"https://github.com/GzkThunder"
        },
        loginUser:{},
        token:"",
        deviceType:type,
